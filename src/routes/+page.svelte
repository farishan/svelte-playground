<script>
	...
	import ConfirmTest from '../actions/ConfirmTest.svelte';
	import HeadedMovableBlaBlaTest from '../components/HeadedMovableBlaBlaTest.svelte';
	import MovableRectangleTest from '../components/MovableRectangleTest.svelte';
	import MovableTest from '../actions/MovableTest.svelte';
